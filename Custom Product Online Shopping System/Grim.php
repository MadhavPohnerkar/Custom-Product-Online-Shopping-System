...
<div class="header">
		...
		<table class="t1" width="50%" align="right" border="0">
			<tr>
				...
				<td align="center" class="d1"><p class="p2"><a href="categories.php">Categories</a></td>
...
<table width="90%" cellpadding="10" border="0" align="center" bgcolor="#FFF">
	...
	<tr>
		<td colspan="3"><p class="p1">Mousepads > Grimmjow</p></td>
	</tr>

	<tr>
		<td rowspan="2" width="20%" align="center"><img src="images/mp3.jpg" height="100" width="150" ></td>
<td rowspan="6" width="50%" align="center"><img src="images/mp3.jpg" height="300" width="400" ></td>
...
<table width="90%" cellpadding="10" border="0" align="center" bgcolor="#FFF">
	...
	<tr><td>Dimensions : 235 x 195 mm</td></tr>
	<tr><td>Finish : Dye-sublimation printing with smooth feel</td></tr>
	<tr><td>Thickness : 6 mm</td></tr>
	<tr><td><p class="p1">About the product</p></td></tr>
	<tr><td> We here at Designgenics take pride in keeping our customers' need foremost. Hence, while making this Mousepad we have ensured that we use highest quality safe products which is eco friendly.</td></tr>
</table>
<br>
...
<div class="footer">
	...
	<table width="60%" align="center" border="0">
		...
		<tr>
			<td align="center"><p class="p4"><a href="locate.php">locate us</a></p></td>
...
<div class="header">
		...
		<table  width="30%" align="left" border="0">
			<td align="center"><p class="p3"><a href="home.ph
<!DOCTYPE html>
<html>
<head>
	<link rel="stylesheet" type="text/css" href="style.css">
...
<table width="90%" cellpadding="10" border="0" align="center" bgcolor="#FFF">
	...
	<tr>
		<td colspan="3"><p class="p1">Mousepads > John Wick</p></td>
	</tr>

	<tr>
		<td rowspan="2" width="20%" align="center"><img src="images/mp2.jpg" height="100" width="150" ></td>
<td rowspan="6" width="50%" align="center"><img src="images/mp2.jpg" height="300" width="400" ></td>
		<td><h3>Quantity</h3><select><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option>
		 	</select>
		</td>
	</tr>
...
p">Designgenics</a></p></td>
		...
		<td><h3>Quantity</h3><select><option value="1">1</option><option value="2">width2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option>
	<tr>">
...
<table width="90%" cellpadding="10" border="0" align="center" bgcolor="#FFF">
	...
	<tr>
		<td colspan="3"><p class="p1"> Mouse Pads > Grimmjow</p></td>
	</tr>
		<td rowspan="2" ="20%"></td>
...
<table width="90%" cellpadding="10" border="0" align="center" bgcolor="#FFF">
	...
	<tr><td><p class="p1">About the product</p></td></tr>
	<tr><td> From the famous anime series Bleach, which follows the story Ichigo a Soul Reaper. We bring you the brand new design featuring the famous Espada Grimmjow in a unique artwork on quality mousepad.</td></tr>
</table>
<br>
