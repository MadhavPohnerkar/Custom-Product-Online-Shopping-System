...
<table width="90%" cellpadding="10" border="0" align="center" bgcolor="#FFF">
	...
	<tr>
		<td colspan="3"><p class="p1">Mugs > Goku vs Vigata</p></td>
	</tr>

	<tr>
		<td rowspan="2" width="20%" align="center"><img src="images/mug3.jpg" height="100" width="180" ></td>
<td rowspan="6" width="50%" align="center"><img src="images/mug3.jpg" height="250" width="400" ></td>
...
<table width="90%" cellpadding="10" border="0" align="center" bgcolor="#FFF">
	...
	<tr><td>Dimensions : 13x 9.8 x 9.2 cm, 400 g </td></tr>
	<tr><td>color : Multicolor</td></tr>
	<tr><td>Material: Bone Ciana</td></tr>
	<tr><td><p class="p1">About the product</p></td></tr>
	<tr><td> We here at Designgenics take pride in keeping our customers' need foremost. Hence, while making this Mug we have ensured that we use highest quality safe products which is eco friendly.</td></tr>
</table>
<br>
