...
<table width="90%" cellpadding="10" border="0" align="center" bgcolor="#FFF">
	...
	<tr>
		<td colspan="3"><p class="p1">Posters > Conquer, Discipline, Immortality</p></td>
	</tr>

	<tr>
		<td rowspan="2" width="20%" align="center"><img src="images/4.png" height="110" width="110" ></td>
<td rowspan="6" width="50%" align="center"><img src="images/4.png" height="400" width="400" ></td>
...
<table width="90%" cellpadding="10" border="0" align="center" bgcolor="#FFF">
	...
	<tr><td>Dimensions : A3</td></tr>
	<tr><td>Finish: Glossy</td></tr>
	<tr><td>Sheet Quality : 100 GSM</td></tr>
	<tr><td><p class="p1">About the product</p></td></tr>
	<tr><td> We here at Designgenics take pride in keeping our customers' need foremost. Hence, while making this Poster we have ensured that we use highest quality safe products which is eco friendly.</td></tr>
</table>
<br>
