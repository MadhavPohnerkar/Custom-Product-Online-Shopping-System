...
<table width="90%" cellpadding="10" border="0" align="center" bgcolor="#FFF">
	...
	<tr>
		<td colspan="3"><p class="p1">Badges > Super Family badge</p></td>
	</tr>

	<tr>
		<td rowspan="2" width="20%" align="center"><img src="images/Badge5.png" height="110" width="110" ></td>
<td rowspan="6" width="50%" align="center"><img src="images/Badge5.png" height="400" width="400" ></td>
	...
	<tr>
		<td>Rs. 100
			<input type="submit" name="pay" value="pay"></a></td>
	</tr>
</table>
...
<table width="90%" cellpadding="10" border="0" align="center" bgcolor="#FFF">
	...
	<tr><td>Diameter: 5.8cm</td></tr>
	<tr><td>Finish: Glossy</td></tr>
	<tr><td>Material: Polycarbonate with pin fastener</td></tr>
	<tr><td><p class="p1">About the product</p></td></tr>
	<tr><td> We here at Designgenics take pride in keeping our customers' need foremost. Hence, while making this badge we have ensured that we use highest quality safe products which is eco friendly.</td></tr>
</table>
<br>
